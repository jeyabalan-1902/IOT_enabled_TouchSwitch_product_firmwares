...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(2), 15, PRSC_DIV_SEL_8, NODE_GAIN(GAIN_4, GAIN_4), FILTER_LEVEL_64                                    \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(1), 15, PRSC_DIV_SEL_8, NODE_GAIN(GAIN_4, GAIN_4), FILTER_LEVEL_64                                   \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(0), 15, PRSC_DIV_SEL_8, NODE_GAIN(GAIN_4, GAIN_4), FILTER_LEVEL_64                                   \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(3), 15, PRSC_DIV_SEL_8, NODE_GAIN(GAIN_4, GAIN_4), FILTER_LEVEL_64                                    \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(4), 15, PRSC_DIV_SEL_8, NODE_GAIN(GAIN_4, GAIN_4), FILTER_LEVEL_64                                    \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(5), 15, PRSC_DIV_SEL_8, NODE_GAIN(GAIN_4, GAIN_4), FILTER_LEVEL_64                                    \
	}
